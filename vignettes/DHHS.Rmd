...
df['RAW_STRING'] = unlabelled

for i, row in enumerate(labelled):
    for item in row:
        df[item[0]][i] = item[1]

df.to_csv('C:/Users/farrelp1/Documents/GNAFAPI/data/labelled_DHHS.csv', index=False)

```

```{r}

labelled_DHHS <- read.csv("C:/Users/farrelp1/Documents/GNAFAPI/data/labelled_DHHS.csv", stringsAsFactors = F)
